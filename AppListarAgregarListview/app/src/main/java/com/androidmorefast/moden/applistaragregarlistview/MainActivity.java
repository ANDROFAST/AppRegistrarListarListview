package com.androidmorefast.moden.applistaragregarlistview;
...
public class MainActivity extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    private String URL_NEW_FRUTA = "http://192.168.1.39:8080/blog/listview/agregar.php";
    // Url listar las frutas
    private String URL_LISTA_FRUTA = "http://192.168.1.39:8080/blog/listview/listar.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaFruta = (ListView) findViewById(R.id.listFrutas);
        txtAgregar = (TextView) findViewById(R.id.txtFruta);

        frutasList = new ArrayList<Frutas>();

        // seleccionar las frutas del listview
        listaFruta.setOnItemSelectedListener(this);
    ...
    private void populateListview(){
        ...
        ListViewAdapter
                .setDropDownViewResource(android.R.layout.simple_list_item_activated_2);


        listaFruta.setAdapter(ListViewAdapter);
